var YPlaylist = {
    ...
    fetch: function() {
        var a = this,
            b = $('<div class="placeholder"></div>'),
            c = $('<div class="carousel-container"><span class="prev controll"></span><div class="carousel-inner"><ul class="slider"></ul></div><span class="next controll"></span></div>');
        $.getJSON(a.url, function(d) {
            var e, f, g = "",
                h = {},
                i = d.items;
            for (a.shuffle && i.sort(function() {
                    return .5 - Math.random()
                }), $(a.container).append(b), $(b).html(function() {
                    var a = i[0].snippet.resourceId.videoId;
